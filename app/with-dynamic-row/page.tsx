...
import { WithDynamicRowTable } from '@/views/with-dynamic-row'

export default async function WithDynamicRowPage({
  searchParams,
}: {
  ...
  return <WithDynamicRowTable initialData={initialData} />
}
