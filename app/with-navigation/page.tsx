...
import { WithNavigationTable } from '@/views/with-navigation'

export default async function WithNavigationPage({
  searchParams,
}: {
  ...
  return <WithNavigationTable initialData={initialData} />
}
