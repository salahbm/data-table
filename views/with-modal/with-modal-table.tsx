...
import { WITH_MODAL_COLUMNS } from './with-modal-columns'

interface WithModalTableProps {
  initialData: {
    data: Product[]
    meta: {
      page: number
...
export const WithModalTable = ({ initialData }: WithModalTableProps) => {
